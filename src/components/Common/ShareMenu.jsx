...
const ShareMenu = ({ currentUrl, shouldGenerateRoomCode, appName, showModal, hideModal, entryFee, categoryName }) => {
    ...
    const shareButtons = (
        <>
            <FacebookShareButton
                url={currentUrl}
                title={`Dive into the ultimate quiz battle showdown on Quizaa, Join the squad using code: ${shouldGenerateRoomCode} Category : ${categoryName}, Just ${entryFee} Coins to play—let's crush it!`}
                hashtag={appName}
            >
